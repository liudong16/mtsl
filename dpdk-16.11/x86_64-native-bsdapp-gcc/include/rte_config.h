...
#undef RTE_EXEC_ENV_BSDAPP
#define RTE_EXEC_ENV_BSDAPP 1
#undef RTE_CONTIGMEM_MAX_NUM_BUFS
#define RTE_CONTIGMEM_MAX_NUM_BUFS 64
#undef RTE_CONTIGMEM_DEFAULT_NUM_BUFS
#define RTE_CONTIGMEM_DEFAULT_NUM_BUFS 2
#undef RTE_CONTIGMEM_DEFAULT_BUF_SIZE
