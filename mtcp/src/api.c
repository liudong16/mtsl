...
#include "/home/liudong16/mtcp_ttt/mtcp/src/include/ctx_s.h"
extern pthread_t thread_ids[MAX_CPUS];
extern thread_context_t g_ctxs[MAX_CPUS];
extern int core_limit;
thread_context_t ctx_s;
int note = 0;
int i = 0;
...
/*----------------------------------------------------------------------------*/
int
socket1(int domain, int type, int protocol)
//mtcp_socket(mctx_t mctx1, int domain, int type, int protocol)
{
	mtcp_manager_t mtcp;
	socket_map_t socket;
...
/*
int
mtcp_bind(mctx mctx, int sockid,
		const struct sockaddr *addr, socklen_t addrlen)
*/
int bind1(int sockid, const struct sockaddr *addr, socklen_t addrlen)
{
	mtcp_manager_t mtcp;
	struct sockaddr_in *addr_in;
...
//modified by liudong16
int
listen1(int sockid, int backlog)
...
//modified by liudong16
int
accept1(int sockid, struct sockaddr *addr, socklen_t *addrlen)
...
/*----------------------------------------------------------------------------*/
ssize_t
recv1(int sockid, char *buf, size_t len, int flags)
...
write1(int sockid, const char *buf, size_t len)
{
	mtcp_manager_t mtcp;
	socket_map_t socket;
	tcp_stream *cur_stream;
